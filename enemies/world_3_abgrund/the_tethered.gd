...
const FRAME_REGIONS: Array = [
	Rect2(20, 30, 530, 1400),    # 0: IDLE
	Rect2(570, 30, 530, 1400),   # 1: CHASE
	Rect2(1120, 30, 530, 1400),  # 2: ATTACK_WINDUP
	Rect2(1670, 30, 530, 1400),  # 3: ATTACK_ACTIVE
	Rect2(2220, 30, 530, 1400),  # 4: STUNNED
]
