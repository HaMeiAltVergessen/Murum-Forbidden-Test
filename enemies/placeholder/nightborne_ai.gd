extends Node
class_name NightborneAI

## AI Controller for Nightborne (Fast Agile Enemy)
...
func _find_player() -> void:
	...
	print("[NightborneAI] Initialized, target: %s" % (target_player.name if target_player else "none"))
