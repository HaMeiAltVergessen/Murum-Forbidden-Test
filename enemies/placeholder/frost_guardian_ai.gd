extends Node
class_name FrostGuardianAI

## AI Controller for FrostGuardian (Tank Enemy)
...
func _find_player() -> void:
	...
	print("[FrostGuardianAI] Initialized, target: %s" % (target_player.name if target_player else "none"))
