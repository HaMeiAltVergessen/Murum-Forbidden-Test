extends Node
class_name DarkFantasyAI

## AI Controller for DarkFantasy (Balanced Enemy)
...
func _find_player() -> void:
	...
	print("[DarkFantasyAI] Initialized, target: %s" % (target_player.name if target_player else "none"))
