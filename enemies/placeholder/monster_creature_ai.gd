extends Node
class_name MonsterCreatureAI

## AI Controller for MonsterCreature (Medium Enemy)
...
func _find_player() -> void:
	...
	print("[MonsterCreatureAI] Initialized, target: %s" % (target_player.name if target_player else "none"))
