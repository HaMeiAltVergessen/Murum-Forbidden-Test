...
const FRAME_REGIONS: Array = [
	Rect2(0, 30, 170, 420),     # 0: PATROL
	Rect2(170, 30, 170, 420),   # 1: SHIELD
	Rect2(340, 30, 170, 420),   # 2: CHARGE
	Rect2(510, 30, 170, 420),   # 3: COMBO
	Rect2(680, 30, 170, 420),   # 4: RALLY
	Rect2(850, 30, 170, 420),   # 5: STUNNED
]
